...
const Skills = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ['Spring Boot', 'Spring Security', 'Hibernate', 'REST APIs', 'Microservices', 'JWT Authentication', 'Node.js', 'Express.js', 'WebSocket']
    },
    {
      title: 'Databases',
      icon: Database,
    ...
    },
    {
      ...
      skills: ['AWS (EC2, S3, RDS)', 'Docker', 'Kubernetes', 'CI/CD', 'GitHub Actions', 'Git']
    },
    {
      title: 'Tools & Messaging',
      icon: Terminal,
      color: 'from-teal-500 to-blue-500',
      skills: ['Apache Kafka', 'RabbitMQ', 'Maven', 'JUnit', 'Postman']
    },
    {
