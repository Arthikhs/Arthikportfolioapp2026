...
const About = () => {
  ...
  const skills = [
    ...
    'React.js', 'Next.js', 'Spring Boot',
    'Node.js', 'REST APIs', 'Microservices',
    'JWT', 'PostgreSQL', 'MySQL', 'MongoDB', 'Redis',
    'Docker', 'AWS', 'Kafka', 'RabbitMQ'
  ];
        ...
        >
            ...
            <motion.div variants={itemVariants} className="glass rounded-2xl p-6 space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <a href="mailto:hsarthik5@gmail.com" className="text-gray-300 hover:text-white transition-colors">
                    hsarthik5@gmail.com
                  </a>
                </div>
                <div className="flex items-center space-x-3">
              ...
              <div className="flex space-x-4 pt-4">
                <motion.a
                  href="https://github.com/Arthikhs"
                  target="_blank"
                ...
                <motion.a
                  href="https://www.linkedin.com/in/arthik-h-s-31b2a4318/"
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ scale: 1.1, rotate: 5 }}
                  whileTap={{ scale: 0.9 }}
                ...
                <motion.a
                  href="mailto:hsarthik5@gmail.com"
                  whileHover={{ scale: 1.1, rotate: 5 }}
                  whileTap={{ scale: 0.9 }}
                  className="p-3 glass rounded-lg hover:bg-blue-500/20 transition-colors"
                >
          ...
          <motion.div variants={itemVariants} className="space-y-8">
            <div>
              ...
              >
                Java Full-Stack Developer with hands-on experience in Java, Spring Boot, REST APIs, Microservices, MySQL, and PostgreSQL. Skilled in building scalable web applications with JWT Authentication, Apache Kafka, RabbitMQ, Docker, and AWS.
              </motion.p>
              <motion.p
                variants={itemVariants}
                className="text-lg text-gray-300 leading-relaxed mb-8"
              >
                Strong foundation in Data Structures and Algorithms, OOP, DBMS, and System Design, with experience developing secure backend services and distributed applications.
              </motion.p>
            </div>
