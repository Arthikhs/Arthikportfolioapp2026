...
const Hero = () => {
  ...
  const techStack = [
    ...
    'Docker • AWS • Kafka • RabbitMQ • CI/CD'
  ];
    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="text-center">
          ...
          >
            <span className="gradient-text">Arthik H S</span>
          </motion.h1>
          ...
          >
            Java Full-Stack Developer skilled in Spring Boot, REST APIs, Microservices, and AWS. Building secure backend services and distributed applications with Kafka, Docker, and modern DevOps practices.
          </motion.p>
