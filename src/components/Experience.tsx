  ...
  const experiences = [
    {
      ...
      description: 'Developed secure banking REST APIs and gained hands-on experience in full-stack Java development.',
      achievements: [
        'Developed secure banking REST APIs using Java, Spring Boot, and MySQL',
        'Implemented JWT Authentication and role-based access control for secure access management',
        'Designed database operations using Spring Data JPA and MySQL for efficient data persistence and retrieval',
        'Applied exception handling, validation, and debugging techniques to improve application reliability'
      ],
      techStack: ['Java', 'Spring Boot', 'MySQL', 'JWT', 'Spring Data JPA', 'REST APIs'],
      type: 'current'
    }
  ];
